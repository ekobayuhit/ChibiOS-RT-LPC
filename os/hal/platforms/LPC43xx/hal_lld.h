...
/**
 * @brief   PLL0USB FIN = XTAL.
 */
#if LPC_PLL0USB_ENABLE
#if !LPC_XTAL_ENABLE
#error "XTAL not enabled for PLL0USB."
#endif
#endif

/**
 * @brief   PLL0USB PLL0USB_MDIV and PLL0USB_NP_DIV
 *          registers values.
 */
#if LPC_PLL0USB_ENABLE && LPC_XTAL_ENABLE
#if XTAL == 1000000
#define LPC_PLL0USB_MDIV        0x073E56C9
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 2000000
#define LPC_PLL0USB_MDIV        0x073E2DAD
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 3000000
#define LPC_PLL0USB_MDIV        0x0B3E34B1
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 4000000
#define LPC_PLL0USB_MDIV        0x0E3E7777
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 5000000
#define LPC_PLL0USB_MDIV        0x0D326667
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 6000000
#define LPC_PLL0USB_MDIV        0x0B2A2A66
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 8000000
#define LPC_PLL0USB_MDIV        0x08206AAA
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 10000000
#define LPC_PLL0USB_MDIV        0x071A7FAA
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 12000000
#define LPC_PLL0USB_MDIV        0x06167FFA
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 15000000
#define LPC_PLL0USB_MDIV        0x05123FFF
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 16000000
#define LPC_PLL0USB_MDIV        0x04101FFF
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 20000000
#define LPC_PLL0USB_MDIV        0x040E03FF
#define LPC_PLL0USB_NP_DIV      0x00302062
#elif XTAL == 24000000
#define LPC_PLL0USB_MDIV        0x030C00FF
#define LPC_PLL0USB_NP_DIV      0x00302062
#else
#if !defined(LPC_PLL0USB_MDIV) && !defined(LPC_PLL0USB_NP_DIV)
#error "PPL0USB error, not defined LPC_PLL0USB_MDIV and LPC_PLL0USB_NP_DIV."
#endif
#endif
#endif

/**
 * @brief   PLL0USB clock frequency set to 480 MHz.
 */
#define LPC_PLL0USB_CLK         480000000
