/*
    ...
    LPC43xx I2C driver - Copyright (C) 2013 Marcin Jokel
...
#if LPC_I2C_USE_I2C0 || defined(__DOXYGEN__)
...
void i2c_lld_start(I2CDriver *i2cp) {
...
#if LPC_I2C_USE_I2C0
    if (&I2CD1 == i2cp) {
      LPC_CCU1->CLK_ABP1_I2C0_CFG = 1;
      i2cpclk = LPC_I2C_I2C0_PCLK;
      nvicEnableVector(I2C0_IRQn,
            CORTEX_PRIORITY_MASK(LPC_I2C_I2C0_IRQ_PRIORITY));
    }
#endif

#if LPC_I2C_USE_I2C1
    if (&I2CD2 == i2cp) {
      LPC_CCU1->CLK_APB3_I2C1_CFG = 1;
      i2cpclk = LPC_I2C_I2C1_PCLK;
      nvicEnableVector(I2C1_IRQn,
            CORTEX_PRIORITY_MASK(LPC_I2C_I2C1_IRQ_PRIORITY));
    }
#endif
  }
  ...
  i2cscl = (i2cpclk/(i2cp->config->clock_timing));
