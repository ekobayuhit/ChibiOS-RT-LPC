 ...
 */
#if !defined(LPC_I2C_USE_I2C0) || defined(__DOXYGEN__)
 ...
 */
#if !defined(LPC_I2C_I2C0_IRQ_PRIORITY) || defined(__DOXYGEN__)
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(LPC_I2C_USE_I2C1) || defined(__DOXYGEN__)
 ...
 */
#if !defined(LPC_I2C_I2C1_IRQ_PRIORITY) || defined(__DOXYGEN__)
 ...
 * @brief   I2C0 clock.
 */
#define LPC_I2C_I2C0_PCLK               LPC_BASE_APB1_CLK

/**
 * @brief   I2C1 clock.
 */
#define LPC_I2C_I2C1_PCLK               LPC_BASE_APB3_CLK
