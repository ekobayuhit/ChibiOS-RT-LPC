...
//  */
//Pengaturan Clock Dicopy dari Pak Furkan (Larantuka)
#define LPC17xx_MAINOSC_ENABLE              FALSE //FALSE karena yg digunakan IRCOSC (Internal RC Oscillator)
#define LPC17xx_SYSCLK_SELECT               CLKSRCSEL_IRCOSC
#define LPC17xx_MAINPLL_ENABLE              TRUE
#define LPC17xx_MAINPLL_MUL                 74	//30 asli, 100 out of range, 90 ok, 80 ok
												// kalau 90, dapat 120 MHz (LPC17xx_CCLK)
												// 80 : 106 MHz
												// 74 : 98 Mhz
												// 70 : 93.333.333 Hz
												// 74 : 98.666.666 Hz
#define LPC17xx_MAINPLL_PREDIV              1	// 1
...
#define LPC17xx_CAN_IRQ_PRIORITY            11 //11
