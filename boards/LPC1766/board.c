...
void boardInit(void) {
  ...
  /*  UART2=Driver SD3 - Bayu - 4 Feb 2019 */
  /*----------------------------*/
  LPC_PINCON->PINSEL4  |= (1 << 17) | (0 << 16);        /*  Set UART2 TXD2 P2.8 */
  LPC_PINCON->PINMODE4 |= (1 << 17) | (0 << 16);        /*  Enables pull-down TXD2 P2.8*/
  LPC_PINCON->PINSEL4  |= (1 << 19) | (0 << 18);        /*  Set UART2 RXD2 P2.9*/
  LPC_PINCON->PINMODE4 |= (1 << 19) | (0 << 18);        /*  Enables pull-down RXD P2.9*/
  /*----------------------------*/
